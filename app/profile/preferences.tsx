...
export default function ProfilePreferencesScreen() {
  ...
  const [contributionUpdates, setContributionUpdates] = useState(true);
  const [leaderboardUpdates, setLeaderboardUpdates] = useState(false);
  const [notificationFrequency, setNotificationFrequency] = useState<NotificationFrequency>('important');
