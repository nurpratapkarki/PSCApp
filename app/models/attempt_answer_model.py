...
from .question_answer_model import Question, Answer
...
class UserAttempt(models.Model):
    ...
    end_time = models.DateTimeField(
        null=True,
        blank=True,
        help_text="When completed/submitted"
    )
...
class UserAnswer(models.Model):
    ...
    is_marked_for_review = models.BooleanField(
        default=False,
        help_text="User flagged to revisit later"
    )
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(
        auto_now=True,
        help_text="Updated when user changes answer"
    )
